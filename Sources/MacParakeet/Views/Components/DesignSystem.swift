...
enum DesignSystem {
    ...
    enum Colors {
        ...
        static let accent = Color(light: .init(red: 0.16, green: 0.45, blue: 0.27),
                                  dark: .init(red: 0.32, green: 0.72, blue: 0.46))
        static let accentLight = Color(light: .init(red: 0.92, green: 0.96, blue: 0.93),
                                       dark: .init(red: 0.32, green: 0.72, blue: 0.46).opacity(0.12))
        static let accentDark = Color(light: .init(red: 0.10, green: 0.32, blue: 0.18),
