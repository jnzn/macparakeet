...
# PDX Edition: Sparkle (auto-update framework) was removed from the
# project. Nothing to embed in Contents/Frameworks/. Updates are
# delivered by rebuilding from source — no in-app update channel.
